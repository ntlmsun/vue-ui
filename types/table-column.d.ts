...
import { MsunUIComponent, MsunUIHorizontalAlignment } from './component';
...
export declare class MsTableColumn extends MsunUIComponent {
  ...
  /** Whether column width can be resized. Works when border of `ms-table` is `true` */
  resizable: boolean;
