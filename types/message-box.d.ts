...
export declare class MsMessageBoxComponent extends Vue {
  title: string;
  message: string;
  type: MessageType;
  iconClass: string;
...
export interface MsMessageBoxOptions {
  ...
  callback?: (action: MessageBoxCloseAction, instance: MsMessageBoxComponent) => void;

  /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
  beforeClose?: (action: MessageBoxCloseAction, instance: MsMessageBoxComponent, done: () => void) => void;
...
export interface MsMessageBoxShortcutMethod {
  (message: string, title: string, options?: MsMessageBoxOptions): Promise<MessageBoxData>;
  (message: string, options?: MsMessageBoxOptions): Promise<MessageBoxData>;
}

export interface MsMessageBox {
  /** Show a message box */
  (message: string, title?: string, type?: string): Promise<MessageBoxData>;

  /** Show a message box */
  (options: MsMessageBoxOptions): Promise<MessageBoxData>;

  /** Show an alert message box */
  alert: MsMessageBoxShortcutMethod;

  /** Show a confirm message box */
  confirm: MsMessageBoxShortcutMethod;

  /** Show a prompt message box */
  prompt: MsMessageBoxShortcutMethod;

  /** Set default options of message boxes */
  setDefaults(defaults: MsMessageBoxOptions): void;
