...
export interface MsUploadInternalRawFile extends File {
  uid: number;
}

export interface MsUploadInternalFileDetail {
  status: FileUploadStatus;
  name: string;
  size: number;
  percentage: number;
  uid: number;
  raw: MsUploadInternalRawFile;
  url?: string;
}

export interface MsUploadProgressEvent extends ProgressEvent {
  percent: number;
}
...
export interface HttpRequestOptions {
  ...
  filename: string;
  action: string;
  onProgress: (e: MsUploadProgressEvent) => void;
  onSuccess: (response: any) => void;
  onError: (err: ErrorEvent) => void;
}

/** Upload Component */
export declare class MsUpload extends MsunUIComponent {
  ...
  onPreview: (file: MsUploadInternalFileDetail) => void;

  /** Hook function when files are removed */
  onRemove: (file: MsUploadInternalFileDetail, fileList: MsUploadInternalFileDetail[]) => void;

  /** Hook function when uploaded successfully */
  onSuccess: (response: any, file: MsUploadInternalFileDetail, fileList: MsUploadInternalFileDetail[]) => void;

  /** Hook function when some errors occurs */
  onError: (err: ErrorEvent, file: MsUploadInternalFileDetail, fileList: MsUploadInternalFileDetail[]) => void;

  /** Hook function when some progress occurs */
  onProgress: (event: MsUploadProgressEvent, file: MsUploadInternalFileDetail, fileList: MsUploadInternalFileDetail[]) => void;

  /** Hook function when file status change */
  onChange: (file: MsUploadInternalFileDetail, fileList: MsUploadInternalFileDetail[]) => void;
  ...
  beforeUpload: (file: MsUploadInternalRawFile) => boolean | Promise<File | Blob | boolean>;
  ...
  onExceed: (file: MsUploadInternalFileDetail, fileList: MsUploadInternalFileDetail[]) => void;

  /** Clear the upload file list */
  clearFiles(): void;

  /** Abort specified file */
  abort(file: MsUploadInternalFileDetail): void;
