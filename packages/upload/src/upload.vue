...
export default {
  ...
  render(h) {
    ...
    data.class[`ms-upload--${listType}`] = true;
    return (
      <div {...data} tabindex="0">
        {drag ? (
        ...
        <input class="ms-upload__input" type="file" ref="input" name={name} on-change={handleChange} multiple={multiple} accept={accept}></input>
      </div>
    );
  }
};
