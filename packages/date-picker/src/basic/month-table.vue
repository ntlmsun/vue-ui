<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="ms-month-table">
    <tbody>
      <tr v-for="(row, key) in rows" :key="key">
        <td :class="getCellStyle(cell)" v-for="(cell, key) in row" :key="key">
          <div>
            <a class="cell">{{ t('msun.datepicker.months.' + months[cell.text]) }}</a>
          </div>
        </td>
      </tr>
    </tbody>
...
import { isDate, range, getDayCountOfMonth, nextDate } from 'msun-lib-ui/shared/utils/date-util';
import { hasClass } from 'msun-lib-ui/shared/utils/dom';
import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'msun-lib-ui/shared/utils/util';
