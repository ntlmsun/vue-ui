...
import MsRadio from 'msun-lib-ui/packages/radio';
import { isEqual } from 'msun-lib-ui/shared/utils/util';
...
export default {
  ...
  methods: {
    ...
    renderCheckbox(h) {
      ...
      return <ms-checkbox value={node.checked} indeterminate={node.indeterminate} disabled={isDisabled} {...events}></ms-checkbox>;
    },
    ...
    renderRadio(h) {
      ...
      return (
        <ms-radio value={checkedValue} label={value} disabled={isDisabled} onChange={this.handleCheckChange} nativeOnClick={stopPropagation}>
    ...
    renderCheckIcon(h) {
      return <i class="ms-icon-check ms-cascader-node__prefix"></i>;
    },

    renderLoadingIcon(h) {
      return <i class="ms-icon-loading ms-cascader-node__postfix"></i>;
    },

    renderExpandIcon(h) {
      return <i class="ms-icon-arrow-right ms-cascader-node__postfix"></i>;
    },
    ...
    renderContent(h) {
      ...
      return <span class="ms-cascader-node__label">{vnode || node.label}</span>;
    }
  },
