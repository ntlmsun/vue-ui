import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'msun-lib-ui/shared/utils/dom';
...
export default {
  ...
  render(h) {
    ...
    return (
      <table class="ms-table__header" cellspacing="0" cellpadding="0" border="0">
        <colgroup>
              ...
              {columns.map((column, cellIndex) => (
                ...
                >
                  <div class={['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName]}>
                    ...
                    {column.filterable ? (
                      <span class="ms-table__column-filter-trigger" on-click={$event => this.handleFilterClick($event, column)}>
                        <i class={['ms-icon-arrow-down', column.filterOpened ? 'ms-icon-arrow-up' : '']} />
                      </span>
                    ) : (
                      ''
                    )}
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.ms-table__column-filter-trigger') || cell;
